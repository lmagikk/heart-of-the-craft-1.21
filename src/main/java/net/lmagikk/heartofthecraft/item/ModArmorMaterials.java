...
public class ModArmorMaterials {
    public static final Holder<ArmorMaterial> NETHUM_ARMOR_MATERIAL = register("nethum",
            ...
            }), 30, 0.3f, 0.1f, () -> ModItems.NETHUM_INGOT.get());

    public static final Holder<ArmorMaterial> WARRUM_ARMOR_MATERIAL = register("warrum",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
            ...
            }), 35, 0.4f, 0.2f, () -> ModItems.WARRUM_INGOT.get());

public static final Holder<ArmorMaterial> ENNUM_ARMOR_MATERIAL = register("ennum",
            Util.make(new EnumMap<>(ArmorItem.Type.class), attribute -> {
            ...
            }), 40, 0.5f, 0.3f, () -> ModItems.ENNUM_INGOT.get());
    ...
    private static Holder<ArmorMaterial> register(String name, EnumMap<ArmorItem.Type, Integer> typeProtection,
        ...
        ResourceLocation location = ResourceLocation.fromNamespaceAndPath(HeartOfTheCraft.MODID, name);
