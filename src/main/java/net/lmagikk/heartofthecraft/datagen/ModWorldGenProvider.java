...
import net.lmagikk.heartofthecraft.worldgen.ModBiomeModifiers;
import net.lmagikk.heartofthecraft.worldgen.ModConfiguredFeatures;
...
public class ModWorldGenProvider extends DatapackBuiltinEntriesProvider {
    ...
    public ModWorldGenProvider(PackOutput output, CompletableFuture<HolderLookup.Provider> registries) {
        super(output, registries, BUILDER, Set.of(HeartOfTheCraft.MODID));
    }
}
